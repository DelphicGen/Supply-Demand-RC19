...
const Sidebar = props => {
   ...
   return (
      <React.Fragment>
         <div style={styles.container(mediaQuery)} className="bg-blue-800 rounded-t-lg md:rounded-t-none md:rounded-r-lg  text-center fixed md:sticky md:static bottom-0 md:pt-10 md:top-0 md:left-0 h-16 md:h-screen md:relative">
