...
const Sidebar = props => {
    return (
        <div className="w-full md:w-1/4 lg:w-1/5 bg-blue-800 rounded-t-lg md:rounded-t-none md:rounded-r-lg md:bg-blue-800 text-center fixed bottom-0 md:pt-10 md:top-0 md:left-0 h-16 md:h-screen">
